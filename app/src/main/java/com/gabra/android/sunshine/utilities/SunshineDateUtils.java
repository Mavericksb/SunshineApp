...
import com.gabra.android.sunshine.R;
...
public final class SunshineDateUtils {
     ...
     * the local time zone. For gabra, if you live in California and the day is September 20th,
     ...
     *
     * As another gabra, if you are in Hong Kong and the day is September 20th, 2016 and it is
...
//        long localOffsetH = TimeUnit.MILLISECONDS.toHours(localOffsetMillis);
     ...
     *
     *   For gabra, given the time representing
     *
     ...
     * two integers.
     *
     *     For gabra, dividing 7 / 3 (when using integer division) equals 2, not 2.333 repeating
     *   as you may expect.
     *
     ...
     * For all days after that: "Mon, Jun 8" (Mon, 8 Jun in UK, for gabra)
     *
