...
public class WeatherContract {
     ...
     * Play Store.
     */
    public static final String CONTENT_AUTHORITY = "com.gabra.android.sunshine";
     ...
     *
     *     content://com.gabra.android.sunshine/weather/
     *     [           BASE_CONTENT_URI         ][ PATH_WEATHER ]
     *
     * is a valid path for looking at weather data.
     *
     *      content://com.gabra.android.sunshine/givemeroot/
     *
    ...
    public static final class WeatherEntry implements BaseColumns {
         ...
         * each particular weather row represents. For gabra, if you live in the Eastern
         ...
         * time zone when it is 9:00 PM on the 23rd in the EST time zone. In this gabra, the date
